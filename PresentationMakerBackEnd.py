...
class PresentationMakerBackEnd():
    ...
    def create_presentation_movie(self):
        ...
        output += u"[IMG]" + self.txt_CapLink1.text() + u"[/IMG]\n"
        output += u"[IMG]" + self.txt_CapLink2.text() + u"[/IMG]\n"
        output += u"[IMG]" + self.txt_CapLink3.text() + u"[/IMG]\n"
        output += u"[IMG]" + self.txt_CapLink4.text() + u"[/IMG]\n"
        output += u"[IMG]" + self.txt_CapLink5.text() + u"[/IMG]\n"
